...
namespace Fail2Rdp.UI.Fail2RdpService {
    ...
    public interface IFail2RdpWCFService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://Fail2Rdp.Service/IFail2RdpWCFService/AddWhitelist", ReplyAction="http://Fail2Rdp.Service/IFail2RdpWCFService/AddWhitelistResponse")]
        void AddWhitelist(string ip);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://Fail2Rdp.Service/IFail2RdpWCFService/AddWhitelist", ReplyAction="http://Fail2Rdp.Service/IFail2RdpWCFService/AddWhitelistResponse")]
        System.Threading.Tasks.Task AddWhitelistAsync(string ip);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://Fail2Rdp.Service/IFail2RdpWCFService/RemoveWhitelist", ReplyAction="http://Fail2Rdp.Service/IFail2RdpWCFService/RemoveWhitelistResponse")]
        bool RemoveWhitelist(string ip);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://Fail2Rdp.Service/IFail2RdpWCFService/RemoveWhitelist", ReplyAction="http://Fail2Rdp.Service/IFail2RdpWCFService/RemoveWhitelistResponse")]
        System.Threading.Tasks.Task<bool> RemoveWhitelistAsync(string ip);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://Fail2Rdp.Service/IFail2RdpWCFService/GetWhitelist", ReplyAction="http://Fail2Rdp.Service/IFail2RdpWCFService/GetWhitelistResponse")]
        string[] GetWhitelist();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://Fail2Rdp.Service/IFail2RdpWCFService/GetWhitelist", ReplyAction="http://Fail2Rdp.Service/IFail2RdpWCFService/GetWhitelistResponse")]
        System.Threading.Tasks.Task<string[]> GetWhitelistAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IFail2RdpWCFServiceChannel : Fail2Rdp.UI.Fail2RdpService.IFail2RdpWCFService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Fail2RdpWCFServiceClient : System.ServiceModel.ClientBase<Fail2Rdp.UI.Fail2RdpService.IFail2RdpWCFService>, Fail2Rdp.UI.Fail2RdpService.IFail2RdpWCFService {
        ...
        public void AddWhitelist(string ip) {
            base.Channel.AddWhitelist(ip);
        }
        
        public System.Threading.Tasks.Task AddWhitelistAsync(string ip) {
            return base.Channel.AddWhitelistAsync(ip);
        }
        
        public bool RemoveWhitelist(string ip) {
            return base.Channel.RemoveWhitelist(ip);
        }
        
        public System.Threading.Tasks.Task<bool> RemoveWhitelistAsync(string ip) {
            return base.Channel.RemoveWhitelistAsync(ip);
        }
        
        public string[] GetWhitelist() {
            return base.Channel.GetWhitelist();
        }
        
        public System.Threading.Tasks.Task<string[]> GetWhitelistAsync() {
            return base.Channel.GetWhitelistAsync();
        }
    }
}
